    ...
    <section className="h-dvh bg-[url('/Fondo_Gym.jpg')] bg-no-repeat bg-center bg-[length:100%_100%] snap-start flex items-center justify-center overflow-hidden">
      ...
      <div className="grid gap-1 w-full mx-auto text-center overflow-hidden">
        ...
        <motion.div
          ...
          className="relative w-full h-[50dvh] min-[375px]:h-[55dvh] mx-auto mt-4 overflow-hidden rounded-lg z-0"
        >
          <Image
        ...
        <motion.div
          ...
          className="w-full mx-auto px-4"
        >
          <button className="w-[90%] h-15 mt-4 py-2 border border-black rounded-sm bg-gradient-to-b from-[#02a3ff] via-black to-[#02a3ff] text-white font-bold font-['Codec_Pro']">
            CONÓCENOS
          </button>
          <button className="w-[90%] h-15 mt-2 mb-4 py-3 border border-black rounded-sm bg-gradient-to-b from-[#02a3ff] via-black to-[#02a3ff] text-white font-bold font-['Codec_Pro']">
            CONTACTÁNOS
          </button>
        </motion.div>
