export default function Section6() {
    return (
        <section className="h-dvh bg-[url('/mujer_vs_ia.png')] bg-center bg-[length:120%_100%] bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col snap-start items-center justify-center">
            ...
            >
                <h1 className="font-[Impact] text-red-600 text-4xl sm:text-5xl md:text-6xl -translate-y-40 flex justify-center text-center [-webkit-text-stroke:1px_white]">LA IA NO TRANSPIRA</h1>
                <h2 className="font-[Codec Pro] text-white tracking-[7px] -mt-4 text-sm sm:text-base md:text-lg -translate-y-40 flex justify-center pt-2 ">TU PROGRESO NO ES UN ALGORITMO</h2>
