...
export default function Section6() {
    return (
        <section id="section8" className="flex flex-col h-[80vh] snap-start items-center">
            ...
            <div id="descripcion2" className="mt-5 translate-y-0 flex flex-col items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl shadow-lg text-center max-w-[90%] mx-auto">
